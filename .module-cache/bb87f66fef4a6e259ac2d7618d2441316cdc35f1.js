...
var Game = React.createClass({displayName: 'Game',
    ...
    render: function() {
        ...
        return (
            React.DOM.div(null, 
                React.DOM.div( {id:"board", onClick:this.__onClick, onTouchStart:this.__onClick, onDoubleClick:this.restart, onTouchMove:this.__restart}, 
                ...
                React.DOM.div( {id:"controls"}, 
                    React.DOM.button( {className:"btn", onClick:this.togglePlay} , 
                        this.playButtonText()
                    ),
                    React.DOM.button( {className:"btn", onClick:this.restart}, 
                        "Restart"
                    )
                )
            )
