    ...
    render: function() {
        ...
        return (
            React.DOM.div( {id:"game-container"}, 
                React.DOM.div( {id:"board", style:boardStyle, onClick:this.__onClick}, 
                ...
                React.DOM.div( {id:"controls"}, 
                    React.DOM.button( {className:"btn", style:buttonStyle, onClick:this.togglePlay, onKeyUp:this.handleKeyUp}, 
                        this.playButtonText()
                    ),
                    React.DOM.button( {className:"btn", style:buttonStyle, onClick:this.restart, onKeyUp:this.handleKeyUp, focusEnabled:false}, 
                        "Restart (r)"
                    ),
                    React.DOM.button( {className:"btn", style:buttonStyle, onClick:this.step, onKeyUp:this.handleKeyUp, focusEnabled:false}, 
                        "Step (s)"
                    )
                )
            )
